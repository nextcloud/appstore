...
urlpatterns = [
    ...
    re_path(r"^deprecate-apps/?$", DeprecateAppsView.as_view(), name="account-deprecate-apps"),
    re_path(r"^deprecate-apps/(?P<pk>[a-z0-9_]+)/?$", DeprecateAppsView.as_view(), name="account-deprecate-app"),
