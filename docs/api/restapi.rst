...
* **Request body**:
  ...
  * **is_enterprise_only**: A boolean flag to control whether or not to designate the app as enterprise-only. This cannot be changed after initial app registration
