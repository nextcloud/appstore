...
To change the documentation it is recommended to first install all required libraries in a virtual environment. To do that follow the guide for :ref:`development-installation`
