...
initdb:
	...
	$(manage) createsuperuser --username admin --email admin@admin.com --noinput
	$(manage) verifyemail --username admin --email admin@admin.com
	$(manage) setdefaultadminpassword
